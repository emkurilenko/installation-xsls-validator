...
public enum LightFixtureSheetCell implements SheetCell {
  ...
  START_DATE("Дата начала эксплуатации", 20, "^(([1-9])|(1[0-2]|0[1-9]))/(3[01]|[12][0-9]|0[1-9])/([0-9]{2}|[0-9]{4})$", true),
  ...
  INSPECTION_DATE("Дата осмотра", 38, "^(([1-9])|(1[0-2]|0[1-9]))/(3[01]|[12][0-9]|0[1-9])/([0-9]{2}|[0-9]{4})$", false),
  BYPASS_DATE("Дата объезда", 39, "^(([1-9])|(1[0-2]|0[1-9]))/(3[01]|[12][0-9]|0[1-9])/([0-9]{2}|[0-9]{4})$", false),
  MAINTENANCE_DATE("Дата технического обслуживания", 40,
      "^(([1-9])|(1[0-2]|0[1-9]))/(3[01]|[12][0-9]|0[1-9])/([0-9]{2}|[0-9]{4})$", false),
  REPAIR_DATE("Дата ремонта", 41, "^(([1-9])|(1[0-2]|0[1-9]))/(3[01]|[12][0-9]|0[1-9])/([0-9]{2}|[0-9]{4})$", false),
