...
public enum MultirateMeterCellSheet implements SheetCell {
  ...
  START_DATE("Дата начала эксплуатации", 10, "^(([1-9])|(1[0-2]|0[1-9]))/(3[01]|[12][0-9]|0[1-9])/([0-9]{2}|[0-9]{4})$", true),
  ...
  CHECKING_DATE("Дата поверки", 22, "^(([1-9])|(1[0-2]|0[1-9]))/(3[01]|[12][0-9]|0[1-9])/([0-9]{2}|[0-9]{4})$", false),
  BYPASS_DATE("Дата объезда", 23, "^(([1-9])|(1[0-2]|0[1-9]))/(3[01]|[12][0-9]|0[1-9])/([0-9]{2}|[0-9]{4})$", false),
  MAINTENANCE_DATE("Дата технического обслуживания", 24,
      "^(([1-9])|(1[0-2]|0[1-9]))/(3[01]|[12][0-9]|0[1-9])/([0-9]{2}|[0-9]{4})$", false),
  REPAIR_DATE("Дата ремонта", 25, "^(([1-9])|(1[0-2]|0[1-9]))/(3[01]|[12][0-9]|0[1-9])/([0-9]{2}|[0-9]{4})$", false),
